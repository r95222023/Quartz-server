...
////test
//var queRef = firebaseUtil.ref('https://quartz.firebaseio.com/test');
//var queue = firebaseUtil.queue(queRef, function(data, progress, resolve, reject){
//    console.log(data);
//    setTimeout(function () {
//        resolve();
//    },5000);
//});
//setTimeout(function () {
//    queRef.child('tasks/task001').set({
