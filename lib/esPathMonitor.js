...
PathMonitor.prototype = {
    ...
    _emit: function () {
        ...
        if (emitter&&emitter.emit) emitter.emit(arguments[0],arguments[1]);emitter.emit('index_changed',arguments[1]);
    },
        ...
        self.esc.index({
            ...
            if (error) {
                ...
                snap.ref().child('_index/' + self.hostname).set(response, function (fberr) {
                    ...
                    self._emit('index_added', snap.child('_index'))
                });
            }
        });
    },
            ...
            function onIndex(error, response) {
                ...
                if (error) {
                    ...
                    function updateMeta() {
                        ...
                        self._emit('index_updated', snap.child('_index'));
    ...
    _childRemoved: function (snap, data) {
        ...
        this.esc.delete({
            ...
            if (error) {
                ...
                self._emit('index_removed', snap.child('_index'))
            }
        });
    }
};
